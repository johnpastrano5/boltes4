...
<body>
    ...
    <div id="box">
          ...
          <form method="post">
          	<div class="text-center" style="font_size: 150px;margin: 15px;color:black;font-style: oblique;">Login</div>
            ...
            <a href="#" class="float-right">Forgot Password?</a><br><br>
              ...
              <a href="loginwithgoogle.php" class="btn btn-danger btn-lg btn-block"><i class="fa fa-google"></i> Sign in with <b>Google</b></a> 
          </form>
